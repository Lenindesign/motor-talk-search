...
const HeroCarousel: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[500px] lg:h-[600px] overflow-hidden rounded-2xl shadow-modern-xl">
      {/* Slides */}
            ...
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-12">
                <div className="max-w-4xl">
                  ...
                  <Button 
                    size="lg"
                    className="bg-motortrend-red hover:bg-motortrend-red/90 text-white font-semibold px-8 py-3 rounded-xl shadow-modern transition-all duration-200 hover:shadow-modern-lg"
                  >
                    Read Full Story
                  </Button>
                </div>
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-black/20 backdrop-blur-sm text-white hover:bg-black/40 transition-colors flex items-center justify-center"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-black/20 backdrop-blur-sm text-white hover:bg-black/40 transition-colors flex items-center justify-center"
