  ...
  useEffect(() => {
    ...
    function onScroll() {
      ...
      requestAnimationFrame(() => {
        ...
        let dir = "still";
        if (y > lastY.current + 5) dir = "down";else if (y < lastY.current - 5) dir = "up";else dir = "still";
...
const MobileStickySearch: React.FC<MobileStickySearchProps> = ({
  ...
  useEffect(() => {
    if (window.scrollY < 10) setVisible(true);else if (direction === "down") setVisible(false);else if (direction === "up") setVisible(true);
  }, [direction]);
  return <div className={`
    ...
    willChange: "transform"
      ...
      <div className="py-2 w-full">
        <div className="rounded-2xl bg-white shadow px-[8px] my-[4px]">
