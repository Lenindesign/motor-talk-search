...
const GarageActionMenu: React.FC<GarageActionMenuProps> = ({ car, type, className = "" }) => {
  ...
  if (currentOwnership) {
    ...
    return (
      <Button
        variant={getButtonVariant()} // This will be 'default'
        size="lg"
    ...
    return (
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            variant={getButtonVariant()} // This will be 'outline'
            size="lg"
            className={`gap-1 px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${className}`}
            onClick={(e) => {
            ...
            <CardContent className="p-3 space-y-2">
              ...
              <div className="space-y-1">
                <Button
                  ...
                  onClick={(e) => { e.stopPropagation(); handleAddToGarage('owned'); }}
                >
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full justify-start gap-2"
                  onClick={(e) => { e.stopPropagation(); handleAddToGarage('testDriven'); }}
                >
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full justify-start gap-2"
                  onClick={(e) => { e.stopPropagation(); handleAddToGarage('interested'); }}
                >
                  ...
                  <div className="border-t pt-2 mt-2">
                    ...
                    <div className="space-y-1">
                      <Button
                        ...
                        size="sm"
                        className="w-full justify-start gap-2"
                        onClick={(e) => { e.stopPropagation(); handleScheduleTestDrive(); }}
                      >
                        <Calendar size={14} />
              ...
              {(currentOwnership === 'interested' || !currentOwnership) && type === 'used' && (
                <div className="border-t pt-2 mt-2">
                  <div className="space-y-1">
                    <Button
                      variant="outline"
