...
const ArticleCard: React.FC<ArticleCardProps> = memo(({
  ...
  const { currentImage, isLoading: imageLoading, hasError } = useOptimizedImageLoader({
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <h3 className="font-bold leading-tight text-gray-900 mb-2 text-lg line-clamp-2">
          {article.title}
        </h3>
