  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive 
          ? "bg-motortrend-dark text-white shadow-md border-motortrend-dark hover:text-motortrend-dark" 
          : "text-gray-700 hover:text-motortrend-red hover:bg-gray-100 border-transparent hover:border-gray-200"
      )}
    >
      {section.thumbnail && (
        <div className={cn(
