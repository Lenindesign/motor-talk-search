...
const MyGarageSkinny = () => {
  ...
  return <Card className="mt-6">
      ...
      <CardContent className="pt-0">
        {savedCars.length > 0 ? <div className="space-y-2">
            {savedCars.map(car => <Link to={getResearchUrl(car.id)} key={car.id} className="flex items-center justify-between p-2 rounded-md hover:bg-gray-50">
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded overflow-hidden mr-3 bg-gray-100">
                    {car.imageUrl && <img src={car.imageUrl} alt={car.title} className="w-full h-full object-cover" onError={e => {
                ...
                (e.target as HTMLImageElement).src = '/placeholder.svg';
                  ...
                  <div>
                    ...
                    {car.metadata?.motorTrendScore && <div className="flex items-center mt-0.5">
          ...
          </div> : <div className="text-center py-0">
