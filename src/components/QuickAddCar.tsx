...
const QuickAddCar: React.FC<QuickAddCarProps> = ({ onAddCar }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      {/* Ownership selector */}
      <div className="flex mb-2 justify-end text-sm">
      ...
      <div className="relative flex">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-l-md border border-input px-10 py-2 text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-motortrend-red"
          />
          {query && (
            <button
              onClick={() => {
      ...
      {showSuggestions && filteredSuggestions.length > 0 && (
        <div className="absolute z-10 bg-white w-full max-w-md shadow-lg rounded-b-md">
