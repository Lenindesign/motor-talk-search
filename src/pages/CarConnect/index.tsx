...
const CarConnect = () => {
  ...
  useEffect(() => {
    if (carId) {
      ...
      if (makeData) {
        const modelData = makeData.models.find(m => m.name.toLowerCase() === model && m.year.toString() === year);
        if (modelData) {
          setSelectedCar({
            make: makeData,
            model: modelData
  ...
  return <div className="container mx-auto px-0 py-8">
      <div className="max-w-5xl mx-auto">
        {selectedCar?.make && selectedCar?.model && <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="p-6">
              <div className="flex flex-col md:flex-row gap-8">
                {/* Car Image */}
                <div className="w-full md:w-1/2">
                  <img src={currentImage} alt={`${selectedCar.make.name} ${selectedCar.model.name}`} className="w-full h-[300px] object-cover rounded-lg" />
                </div>
                ...
                <div className="w-full md:w-1/2 space-y-4">
                  ...
                  {selectedCar.model.motorTrendScore && <div className="flex items-center gap-2">
                  ...
                  {selectedCar.model.rank && <div className="text-sm text-gray-600">
                      {selectedCar.model.rank}
                    </div>}

                  <div className="grid grid-cols-2 gap-4 mt-6">
                    {selectedCar.model.msrp && <div>
                    ...
                    {selectedCar.model.estPayment && <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <DealerList carId={carId} selectedDealer={selectedDealer} onDealerSelect={setSelectedDealer} />
          </div>

          {/* Chat Interface Section */}
          <div className="lg:col-span-2">
            {selectedDealer ? <ChatInterface dealer={selectedDealer} /> : <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
