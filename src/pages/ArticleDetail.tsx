    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          <Link 
            to="/" 
            className="inline-flex items-center text-motortrend-red hover:text-motortrend-dark transition-colors font-medium"
          >
        ...
        <article className="prose prose-lg max-w-none">
          {mockContent.sections.map((section, index) => {
            switch (section.type) {
              ...
              case 'heading':
                return (
                  <h2 key={index} className="text-3xl font-bold mt-12 mb-6 text-gray-900 relative">
                    <span className="bg-gradient-to-r from-motortrend-red to-red-400 bg-clip-text text-transparent">
                      {section.content}
                    </span>
                  </h2>
                );
              ...
              case 'specs':
                return (
                  <Card key={index} className="my-8 border-l-4 border-l-motortrend-red">
              ...
              case 'quote':
                return (
                  <blockquote key={index} className="my-8 p-6 bg-gradient-to-r from-motortrend-red/5 to-red-50 border-l-4 border-l-motortrend-red rounded-r-lg">
              ...
              case 'cta':
                return (
                  <Card key={index} className="my-12 bg-gradient-to-r from-motortrend-red to-red-600 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {mockArticles.slice(0, 3).filter(a => a.id !== id).map((relatedArticle) => (
              <Link
                ...
                className="block group hover:shadow-lg transition-all duration-300 rounded-lg overflow-hidden border hover:border-motortrend-red/20"
              >
                <img
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-motortrend-red text-white p-3 rounded-full shadow-lg hover:bg-motortrend-dark transition-all duration-300 z-40"
