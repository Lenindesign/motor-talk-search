  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {/* Section Helper */}
        {[
          { title: 'Latest Videos', icon: <Clock size={24} />, videos: latestVideos },
          { title: 'Car Reviews', icon: <Star size={24} />, videos: carReviews },
          { title: 'Track & Performance', icon: <Flame size={24} />, videos: trackPerformance },
          { title: 'Off-Road & Adventure', icon: <Mountain size={24} />, videos: offRoad },
          { title: 'Classic Cars & Restorations', icon: <Wrench size={24} />, videos: classicCars },
          { title: 'EVs & Future Tech', icon: <Zap size={24} />, videos: evs },
          { title: 'Motorsports', icon: <Flag size={24} />, videos: motorsports },
          { title: 'Trending Now', icon: <TrendingUp size={24} />, videos: trending },
          ...
          <section className="mb-10" key={title}>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              {videos.length > 0 ? videos.map((video) => (
                ...
                <div className="col-span-3 text-gray-400 text-center py-8">No videos in this category yet.</div>
              )}
            </div>
          </section>
        ))}
